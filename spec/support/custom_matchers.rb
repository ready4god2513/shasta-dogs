# from http://nubyonrails.wordpress.com/2008/02/07/creating-a-custom-be_valid-matcher-for-rspec_on_rails/

module CustomMatchers
  #checks that an AR model validates, by testing error messages from .valid?
  #displays any error messages received in test failure output
  class BeValid
